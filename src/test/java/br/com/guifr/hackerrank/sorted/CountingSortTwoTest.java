...
class CountingSortTwoTest {


    @Test
    @DisplayName("Return [3 4 5 7 8] When do CountingSort With [5 7 4 3 8]")
    public void test1() {
        List<Integer> actual = CountingSortTwo.with(Arrays.asList(5,7,4,3,8),10);
    ...
    public void test2() {
        List<Integer> actual = CountingSortTwo.with(Arrays.asList(4,5,3,7,2), 10);
    ...
    public void test3() {
        List<Integer> actual = CountingSortTwo.with(Arrays.asList(5,8,1,3,7,9,2), 10);
    ...
    public void test4() {
        List<Integer> actual = CountingSortTwo.with(Arrays.asList(5,8,1,3,7,9,2,3,7), 10);
